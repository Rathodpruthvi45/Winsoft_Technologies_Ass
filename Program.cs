...
namespace AdoNetConsoleApplication
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            program.CreateTable();
            program.InsertRecord(1, "pruthvi rathod", "pruthvirathod4545@gmail.com", DateTime.Now);
            program.DisplayRecords();
            program.UpdateRecord(1, "Updated pruthvi rathod", "updatedpruthvi@example.com");
            program.DisplayRecords();
